...
flowchart LR
    ...
    A3 --> A4["กรอกหน่วยกิต 3 (2-2-5)<br/>+ gradeScale"]
...
|---|---|---|---|
| 1 | **ฟอร์มสร้าง/แก้ไขรายวิชา** | ไม่มีหน้านี้ = สร้างวิชาไม่ได้เลย ต้องมี section / semester / หน่วยกิต 4 ช่อง / gradeScale | FR-20, FR-27, FR-28 |
